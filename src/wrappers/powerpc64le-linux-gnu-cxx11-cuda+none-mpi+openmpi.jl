# Autogenerated wrapper script for Extrae_jll for powerpc64le-linux-gnu-cxx11-cuda+none-mpi+openmpi
export extrae_cmd, extrae_header, extrae_loader, libmpitrace, libptmpitrace, libpttrace, libseqtrace, mpi2prv, mpimpi2prv
...
function __init__()
    JLLWrappers.@generate_init_header(Binutils_jll, LibUnwind_jll, PAPI_jll, XML2_jll, OpenMPI_jll, MPIPreferences)

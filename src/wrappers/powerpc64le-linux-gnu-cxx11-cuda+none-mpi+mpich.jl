# Autogenerated wrapper script for Extrae_jll for powerpc64le-linux-gnu-cxx11-cuda+none-mpi+mpich
...
function __init__()
    JLLWrappers.@generate_init_header(Binutils_jll, LibUnwind_jll, PAPI_jll, XML2_jll, MPICH_jll, MPIPreferences)

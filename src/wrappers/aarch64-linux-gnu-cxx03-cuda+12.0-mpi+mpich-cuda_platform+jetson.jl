# Autogenerated wrapper script for Extrae_jll for aarch64-linux-gnu-cxx03-cuda+12.0-mpi+mpich-cuda_platform+jetson
...
function __init__()
    JLLWrappers.@generate_init_header(Binutils_jll, LibUnwind_jll, PAPI_jll, XML2_jll, MPICH_jll, MPIPreferences, CUDA_Runtime_jll)
